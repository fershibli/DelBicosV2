...
export const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontFamily: 'Afacad-Bold', color: colors.primaryBlue, marginBottom: 12 },
  sectionTitle: { fontSize: 16, fontFamily: 'Afacad-SemiBold', color: '#333', marginTop: 12, marginBottom: 8 },
  row: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
  month: { width: 48, fontFamily: 'Afacad-Regular' },
  barBackground: { flex: 1, height: 12, backgroundColor: '#eee', borderRadius: 6, marginHorizontal: 8, overflow: 'hidden' },
